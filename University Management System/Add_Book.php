            ...
            <div class="container">
              <form method="post">
                <div class="row gtr-uniform">
                  ...
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="isbn" maxlength="13" size="13" required>
                  </div>
                  <div class="col-6 col-12-xsmall">
                    <label for="Name">Name
                    </label>
                  ...
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="author" maxlength="30" size="30">
                  </div>
                  <div class="col-6 col-12-xsmall">
                  ...
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="publisher" maxlength="30" size="30" required>
                  </div>
                </div>
                <br>
...
$sql = "INSERT INTO book(ISBN, Name, Year, Title, Publisher, Author) VALUES('$isbn', '$name', '$year', '$title', '$publisher', '$author')";
