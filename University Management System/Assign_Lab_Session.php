              ...
              <form method="post">
                <div class="row  gtr-uniform">
                  <div class="col-6 col-12-xsmall">
                    <label for="Section_Number">Section ID
                    </label>
                  </div>
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="section_number" maxlength="5" size="5" required>
                  </div>
                  <div class="col-6 col-12-xsmall">
                  ...
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="course_code" maxlength="4" size="4" required>
                  </div>
                  <div class="col-6 col-12-xsmall">
                    <label for="Lab_Session_ID">Lab Session ID
                    </label>
                  </div>
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="lab_session_id" maxlength="4" size="4" required>
                  </div>
                  <div class="col-6 col-12-xsmall">
                  ...
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="s_id" maxlength="5" size="5" required>
                  </div>
                </div>
                <br>
...
$lab_session_id = isset($_POST['lab_session_id']) ? $_POST['lab_session_id'] : '';
$s_id = isset($_POST['s_id']) ? $_POST['s_id'] : '';
$sql = "INSERT INTO grad_lab_session(Section_ID, Course_Code, Lab_Session_ID, Student_ID) VALUES('$section_number', '$course_code', '$lab_session_id', '$s_id')";
