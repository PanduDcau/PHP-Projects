...
<th>Course Code</th>
<th>Lab Session ID</th>
</tr>";
while($row = $result->fetch_assoc()){
echo "<tr>";
echo "<td>" . $row['Section_ID'] . "</td>";
echo "<td>" . $row['Course_Code'] . "</td>";
echo "<td>" . $row['Lab_Session_ID'] . "</td>";
echo "<tr>";
}
echo "</table>";
}
...
?>
            ...
            <br>
            <a href="Add_Lab_Session.php">
              <button class="button primary">Add Lab Session
              </button>
            </a>
            <!--<a href="Edit_Lab_Session.php">
<button id="edit">Edit Lab Session</button>
</a>-->
            <br>
          </section>
        </div>
