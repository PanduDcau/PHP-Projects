                  ...
                  <form method="post">
                    <div class="row gtr-uniform">
                      <div class="col-6 col-12-xsmall">
                        <label for="CID">Company ID
                        </label>
                      </div>
                      <div class="col-6 col-12-xsmall">
                        <input type="text" value="<?php echo $row['Company_ID']?>" maxlength="4" size="4" disabled>
...
?>
      <?php
//Insert to database
$code = isset($_POST['CID']) ? $_POST['CID'] : '';
$name = isset($_POST['name']) ? $_POST['name'] : '';
if($code!=''){
$sql = "UPDATE company SET Name='".$name."' WHERE Company_ID='".$code."';";
$result = $conn->query($sql);
if($result){
echo "updated";
}
