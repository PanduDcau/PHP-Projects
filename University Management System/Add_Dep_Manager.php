...
<html>
            ...
            <div class="container">
              <form method="post">
                <div class="row gtr-uniform">
                  ...
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="dep_code" maxlength="4" size="4" required>
                  </div>
                  <div class="col-6 col-12-xsmall">
                  ...
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="start_date" maxlength="10" size="10" required>
                  </div>
                  <div class="col-6 col-12-xsmall">
                  ...
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="emp_id" maxlength="4" size="4">
                  </div>
                </div>
                <br>
  ...
  <?php
//Insert to database
$dep_code = isset($_POST['dep_code']) ? $_POST['dep_code'] : '';
$start_date = isset($_POST['start_date']) ? $_POST['start_date'] : '';
$emp_id = isset($_POST['emp_id']) ? $_POST['emp_id'] : '';
$sql = "INSERT INTO department_manager(Dep_Code, Start_Date, Emp_ID) VALUES('$dep_code', '$start_date', '$emp_id')";
