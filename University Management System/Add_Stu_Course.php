            ...
            <div class="container">
              <form method="post">
                <div class="row  gtr-uniform">
                  ...
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="c_code" maxlength="5" size="5" required>
                  </div>
                  <div class="col-6 col-12-xsmall">
                    <label for="Sec_ID">Section Number
                    </label>
                  </div>
                  <div class="col-6 col-12-xsmall">
                    <input type="text" name="sec_ID" maxlength="5" size="5">
                  </div>
                  <div class="col-6 col-12-xsmall">
...
$sql = "INSERT INTO enroll_stu_course(Course_Code, Sec_ID, Student_ID) VALUES('$c_code', '$sec_ID', '$SID')";
