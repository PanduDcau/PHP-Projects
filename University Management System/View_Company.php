...
echo "<td>" . $row['Name'] . "</td>";
echo "<td><a href='Edit_Company.php?id=".$row['Company_ID']."'><button class='button primary small'>Edit</button></a></td>";
echo "<td><a href='Delete_Company.php?id=".$row['Company_ID']."'><button class='button primary small'>Delete</button></a></td>";
echo "<tr>";
}
echo "</table>";
}
...
?>
            ...
            <a href="Reg_Company.php">
              <button class="button primary">Add New Company
              </button>
            </a>
            <br>
          </section>
