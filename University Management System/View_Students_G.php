        ...
        <div class="inner">
          ...
          <section>
            ...
            <div class="table-wrapper">
              <?php
$sql = "SELECT * FROM student WHERE Type='Graduate'";
...
echo "<td><a href='View_Student_Grade.php?id=".$row['Student_ID']."'><button class='button primary small'>View Grades</button></a></td>";
echo "<td><a href='Delete_Student.php?id=".$row['Student_ID']."'><button class='button primary small'>Delete</button></a></td>";
echo "<tr>";
}
echo "</table>";
}
...
?>
            ...
            <a href="Reg_Student.php">
              <button class="button primary">Add New Student
              </button>
            </a>
            <a href="Assign_Lab_Session.php">
              <button class="button primary">Assign Lab Session
              </button>
            </a>
            <br>
          </section>
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <a href="Assign_Lab_Session.php">Lab Sessions
                    </a>
                  </li>
                </ul>
              <li>
