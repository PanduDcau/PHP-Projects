        ...
        <div class="inner">
          ...
          <section>
            ...
            <div class="table-wrapper">
              <?php
$sql = "SELECT * FROM student WHERE Type='Undergraduate'";
...
echo "<td><a href='Add_Stu_Course.php?id=".$row['Student_ID']."'><button class='button primary small'>Enroll Course</button></a></td>";
