...
echo "<td><a href='C_Edit_Company_Session.php?id=".$row['SesID']."'><button class='button primary small'>Edit</button></a></td>";
echo "<td><a href='C_Delete_Company_Session.php?id=".$row['SesID']."'><button class='button primary small'>Delete</button></a></td>";
echo "<tr>";
}
echo "</table>";
}
...
?>
            ...
            <br>
            <a href="C_Add_Company_Session.php">
              <button class="button primary">Add Company Session
              </button>
            </a>
            <a href="C_Add_Company_Assesment.php">
